...
import { FaMapMarkerAlt, FaPhone, FaClock, FaPaperPlane, FaLinkedin, FaGithub, FaTwitter } from 'react-icons/fa'
          ...
          >
            ...
            <div>
              ...
              <div className="flex space-x-4">
                <a href="#" className="bg-gray-100 dark:bg-gray-700 p-3 rounded-full text-gray-700 dark:text-gray-300 hover:bg-blue-100 hover:text-blue-600 dark:hover:bg-blue-900/30 transition-colors">
